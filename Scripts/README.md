...
{% code overflow="wrap" %}
```powershell
Get-ADUser -Identity <SOURCE-USER> -Properties memberof | Select-Object -ExpandProperty memberof | Add-ADGroupMember -Members <TARGET-USER>
```
{% endcode %}
...
### PasswordExpirationsFromOU.ps1exist
